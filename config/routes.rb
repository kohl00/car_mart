Rails.application.routes.draw do
  ...
  resources :cars
    get 'category/make', to: 'cars#by_make', as: 'filter_by_make'
    get 'category/kind', to: 'cars#by_kind', as: 'filter_by_kind'
    get 'category/year', to: 'cars#by_year', as: 'filter_by_year'
